...
const useStyles = makeStyles((theme) => ({
  ...
  image: {
    backgroundImage:
      "url(https://images.unsplash.com/photo-1644182782573-e42d10afea10?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1587&q=80)",
